 ...
 */
package br.com.trackTrail.controller.usuario;
...
public class UsuarioExcluir extends HttpServlet {
   ...
   response.setContentType("text/html;charset=iso-8859-1");
    int idEstado = Integer.parseInt(request.getParameter("idUsuario"));
    ...
    try {
        ...
        if (dao.excluir(idEstado)) {
            ...
            mensagem = "Problemas ao excluir Usuario";
        }
        ...
        System.out.println("Problemas no Servlet ao excluir Usuario! Erro: " + ex.getMessage());
        ex.printStackTrace();
    }
    }
