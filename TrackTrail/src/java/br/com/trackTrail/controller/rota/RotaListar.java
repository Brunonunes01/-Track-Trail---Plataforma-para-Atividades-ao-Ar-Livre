 ...
 * @author Aluno
 */
@WebServlet(name = "RotaListar", urlPatterns = {"/RotaListar"})
public class RotaListar extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            request.getRequestDispatcher("/cadastros/rota/rota.jsp")
                    .forward(request, response);
        } catch (Exception ex){
        //ex.printStackTrace();
        System.out.println("Problemas no Servlet ao Listar"
                + " Rota! Erro: " + ex.getMessage());
        ex.printStackTrace();
        }
    }
